...
<p style="background-color: #f5f5f5; border-left-width: 10px; border-left-style: solid; border-left-color: #CBF8DF;" >
  <b>
  [My next workshop](https://workshops.cpsievert.me/20180303/) is in [March at Plotly HQ in Montréal](https://plotcon.plot.ly/) `r emo::ji("snowflake")`. <br /> [I'm also available](https://consulting.cpsievert.me/) for R training and general consulting.
  </b>
</p>
...
## Bring your work environment to them `r emo::ji("briefcase")` `r emo::ji("laptop")`
