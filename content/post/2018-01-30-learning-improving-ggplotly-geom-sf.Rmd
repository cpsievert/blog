...
<p style="background-color: #f5f5f5; border-left-width: 10px; border-left-style: solid; border-left-color: #CBF8DF;" >
  <b>
   Need help with R, data visualization, and/or statistics? [Hire me](https://consulting.cpsievert.me) or [attend my 2 day workshop](https://plotcon.plot.ly/workshops/r-shiny-dash-r)!
  </b>
</p>
...
For a gentle overview of the linking framework, checkout [my webinar](https://vimeo.com/214301880) from when it was initially released. For more advanced overview, checkout the ['day2' slides](https://workshops.cpsievert.me/20171118/slides/day2/#1) from my previous [plotcon workshop](https://plotcon.plot.ly/. I've also found these skills are best transferred in person at one of [my workshops](https://blog.cpsievert.me/2017/12/04/components-of-a-successful-r-workshop/) ;)
